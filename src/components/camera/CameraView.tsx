...
export function CameraView({ onUsePhoto }: CameraViewProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-zinc-900 aspect-[3/4] w-full max-w-sm mx-auto">
      ...
      {/* ローディング */}
      {state.isLoading && (
        <div data-testid="camera-loading" className="absolute inset-0 flex items-center justify-center bg-zinc-900">
      ...
      {state.error && !state.isLoading && (
        <div
          ...
          className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-zinc-900 p-6 text-center"
        >
